...
3. pytest、Pyright、Ruff、Cython lint、C++ warnings-as-errors、distribution buildを検証する。
...
`0.1.0`、`0.2.0`、`0.4.0`は各release gateを満たす0.x development releaseであり、PyPIへ公開しない。tagは検証済みcommitをmainへ反映してから作成する。
